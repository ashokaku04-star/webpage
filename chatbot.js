...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function tryLocalSearch(query) {
        ...
        if (q.includes('resume') || q.includes('cv') || q.includes('download')) {
            return `You can download Ashoka's latest CV right here: <a href="./data/ASHOKA K U.pdf" target="_blank" style="color:#00D4FF; text-decoration:underline;">Download Resume</a>`;
        }
        return null;
    }
